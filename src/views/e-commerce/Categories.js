...
import { handleOnSubmit } from "./CategoriesAlerts"
...
const Categories = () => {
  ...
  const handleLimit = e => setLimit(parseInt(e.target.value))
  ...
  return (
    <>
      ...
      <CategoryModal
        ...
        onSubmit={e => handleOnSubmit(e, modal, handleModal, setUpdate)}
